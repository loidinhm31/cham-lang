              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div
                      className={`font-semibold ${studyType === "study" ? "text-blue-700 dark:text-blue-400" : "text-(--color-text-primary)"}`}
                    >
                  ...
                  >
                    <div className="text-2xl mb-2">📝</div>
                    <div
                      className={`font-semibold ${studyType === "test" ? "text-blue-700 dark:text-blue-400" : "text-(--color-text-primary)"}`}
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div className="text-2xl mb-2">✅</div>
                      <div
                        className={`font-semibold ${testMode === "normal" ? "text-green-700 dark:text-green-400" : "text-(--color-text-primary)"}`}
                      >
                    ...
                    >
                      <div className="text-2xl mb-2">🔄</div>
                      <div
                        className={`font-semibold ${testMode === "intensive" ? "text-green-700 dark:text-green-400" : "text-(--color-text-primary)"}`}
                      >
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className="text-2xl mb-2">📖</div>
                    <div
                      className={`font-semibold ${contentMode === "definition" ? "text-blue-700 dark:text-blue-400" : "text-(--color-text-primary)"}`}
                    >
                  ...
                  >
                    <div className="text-2xl mb-2">💡</div>
                    <div
                      className={`font-semibold ${contentMode === "concept" ? "text-blue-700 dark:text-blue-400" : "text-(--color-text-primary)"}`}
                    >
