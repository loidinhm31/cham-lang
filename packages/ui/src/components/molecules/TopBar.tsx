...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <div className="sticky top-0 z-40 pt-safe px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 pt-4">
      <div className="flex items-center justify-between bg-[var(--glass-bg)] backdrop-blur-lg rounded-2xl p-4 shadow-lg border border-[var(--color-border-light)] transition-colors duration-300">
        {showBack ? (
          <button
            onClick={handleBackClick}
            className="p-2 hover:bg-white/50 dark:hover:bg-white/10 rounded-xl transition text-[var(--color-text-primary)]"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          {showNotifications ? (
            <button
              ...
              className="p-2 hover:bg-white/50 dark:hover:bg-white/10 rounded-xl transition relative text-[var(--color-text-primary)]"
              title={
                hasSyncNotification
