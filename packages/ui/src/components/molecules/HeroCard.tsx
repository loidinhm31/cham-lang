    ...
    <Card variant="default" className="overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
        ...
        <div className="flex-shrink-0">
          <div className="w-32 h-32 bg-gradient-to-br from-purple-400 to-pink-500 rounded-[32px] border-[4px] border-purple-600 shadow-[0_10px_0_rgba(0,0,0,0.15),0_5px_15px_rgba(0,0,0,0.12)] flex items-center justify-center transform hover:rotate-3 transition-transform duration-300">
