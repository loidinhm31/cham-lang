  ...
  return (
    <Card variant={cardColor} hover onClick={onClick}>
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-start gap-2 mb-2">
            <h3 className="text-2xl font-bold text-(--color-text-primary) flex-1">
              {collection.name}
            </h3>
          ...
          <div className="flex items-center gap-2 text-sm font-semibold text-(--color-primary-600)">
      ...
      {collection.description && (
        <p className="text-(--color-text-primary) font-medium mb-4 line-clamp-2">
          {collection.description}
        </p>
      )}
