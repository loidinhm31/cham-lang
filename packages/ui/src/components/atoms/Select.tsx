      ...
      >
        ...
        <SelectPrimitive.Portal container={container ?? undefined}>
          <SelectPrimitive.Content
            className={cn(
              "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-2xl border-[3px] border-gray-200 bg-white text-gray-800",
              ...
              {options.map((option) => (
                <SelectPrimitive.Item
                  ...
                  className={cn(
                    ...
                    "hover:bg-indigo-50 focus:bg-indigo-100 focus:text-indigo-900",
                    "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                    "data-[state=checked]:bg-indigo-100 data-[state=checked]:text-indigo-900 data-[state=checked]:font-semibold",
                  )}
                >
